...
-   Visualization is a great place to start with Haskell programming, because the payoff is so clear: you get to make elegant and informative plots that help you understand data.
    In @sec-data-visualization you'll dive into visualization, learning the basic structure of a hvega plot, and powerful techniques for turning data into plots.
...
-   Before you can transform and visualize your data, you need to first get your data into Haskell.
    In @sec-data-import you'll learn the basics of getting `.csv` files into Haskell.

Nestled among these chapters are four other chapters that focus on your R workflow.
In @sec-workflow-basics, @sec-workflow-style, and @sec-workflow-scripts-projects you'll learn good workflow practices for writing and organizing your Haskell code.
